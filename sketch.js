...
function verificaOpcaoCreditosOuDescricaoOuComoJogar(){   //FAZ A VERIFICAÇÃO DE MOUSE E TECLADO DA TELA DE CREDITOS
  ...
  switch (tela) { //VOLTAR PARA TELA ANTERIOR APERTANDO O ESCAPE
    case 4: 
      menuEscape(1, 3, false, false); 
      break;
    case 8: 
      menuEscape(3, 1, true, false); 
      break;
    case 12: 
      menuEscape(1, 4, false, false); 
      break;
    case 14: 
      menuEscape(4, 1, false, false); 
      break;
  }
...
function opcaoMenuCorTeclado(xSquare, ySquare, sizeSquare, enter, up, down, left, right, upSelec, downSelec, leftSelec, rightSelec, 
  ...
  if(texto_bool) 
    func_texto(argTexto);  //USADO PARA MOSTRAR A COR SELECIONADA
...
function verificarOpcaoCorCobra(){  //VEFICAÇÃO AÇÃO DO MOUSE E TECLADO
  ...
  if(tecla_Press){             //VERIFICA A AÇAO DO TECLADO E FAZ O MOVIMENTO
    if(verificarBotaoSelecionado)
      verificarPrimeiraSelecao(voltarCorSelecionada)
...
function mudarCorCobra(c){ //FAZ A MUDANÇA DA COR DA COBRA
  switch (c) {
    ...
    case 2:   
      ...
      break;
    case 3:   
      tinta = ('#40E0D0');  //TURQUESA
      break;
    case 4:   
      tinta = ('#008B00');  //VERDE
      break;
    case 5:   
      tinta = ('#FFD700');  //AMARELO
      break;
    case 6:   
      tinta = ('#8B0000');  //VERMELHO
      break;
    case 7:   
      tinta = ('#EE7600');  //LARANJA
      break;
    case 8:   
      tinta = ('#551A8B');  //ROXO
      break;
...
function textoCorCobra(c){  //DEFINI QUAL TEXTO COM O NOME DA COR SERÁ MOSTRADO NA TELA
  push();
    ...
    switch (c) {  //DEFINI QUAL COR ESTÁ SELECIONADA
      case 0: 
        text(idioma[18], (width/2), (height/2)-8); //CINZA
        break;
      case 1: 
        text(idioma[19], (width/2), (height/2)-8); //BRANCO
        break;
      case 2: 
        text(idioma[20], (width/2), (height/2)-8); //AZUL  
        break;
      case 3: 
        text(idioma[21], (width/2), (height/2)-8); //TURQUESA   
        break;
      case 4: 
        text(idioma[22], (width/2), (height/2)-8); //VERDE
        break;
      case 5: 
        text(idioma[23], (width/2), (height/2)-8); //AMARELO 
        break;
      case 6: 
        text(idioma[24], (width/2), (height/2)-8); //VERMELHO
        break;
      case 7: 
        text(idioma[25], (width/2), (height/2)-8); //LARANJA    
        break;
      case 8: 
        text(idioma[26], (width/2), (height/2)-8); //ROXO
        break;
      case 9: 
        text(idioma[27], (width/2), (height/2)-8); //ROSA
        break;
    }
  pop();
}
...
function opcaoSelecVolumeSom(){ //VERIFICA AÇÃO DO MOUSE OU TECLADO NO MENU DE SOM
  ...
  if(tecla_Press){ //VERIFICA E FAZ O MOVIMENTO DO TECLADO
    ...
    switch (botaoSelecionado) {
      case 1: //BOTAO DE MUTE
        verificarOpcaoMenuTecladoSomOuMusica((width/2)+28, (height/2)-58, 36, 40, true, true, false, true, true, true, 0, 1, null, 5, 1, 2, null, 3, 3); 
          break;
      case 2: //VOLUME 1
        verificarOpcaoMenuTecladoSomOuMusica((width/2)+76, (height/2)-58, 36, 40, true, true, false, true, true, true, 0.05, 2, null, 5, 1, 3, null, 3, tela); 
        break;
      case 3: //VOLUME 2
        verificarOpcaoMenuTecladoSomOuMusica((width/2)+124, (height/2)-58, 36, 40, true, true, false, true, true, true, 0.1, 3, null, 5, 2, 4, null, 3, tela); 
        break;
      case 4: //VOLUME 3
        verificarOpcaoMenuTecladoSomOuMusica((width/2)+172, (height/2)-58, 36, 40, true, true, false, true, true, true, 0.15, 4, null, 5, 3, 5, null, 3, tela); 
        break;
      case 5: //VOLUME 4
        verificarOpcaoMenuTecladoSomOuMusica((width/2)+220, (height/2)-58, 36, 40, true, true, false, true, true, true, 0.2, 5, null, 5, 4, 6, null, 3, tela); 
        break;
      case 6: //VOLUME 5
        verificarOpcaoMenuTecladoSomOuMusica((width/2)+268, (height/2)-58, 36, 40, true, true, false, true, true, false, 0.25, 6, null, 5, 5, null, null, 3, tela); 
        break;
    }
  }
  ...
  switch (verificarVolumeSom){  //VERIFICA QUAL OPÇÃO DE VOLUME FOI ESCOLHIDA E DEIXA A OPÇÃO ESCOLHIDA MAIS ESCURA
    case 1: 
      opcaoSelecionada_de_SomOuMusica((width/2)+28, (height/2)-58, 36, 40); 
      break;
    case 2: 
      opcaoSelecionada_de_SomOuMusica((width/2)+76, (height/2)-58, 36, 40); 
      break;
    case 3: 
      opcaoSelecionada_de_SomOuMusica((width/2)+124, (height/2)-58, 36, 40); 
      break;
    case 4: 
      opcaoSelecionada_de_SomOuMusica((width/2)+172, (height/2)-58, 36, 40); 
      break;
    case 5: 
      opcaoSelecionada_de_SomOuMusica((width/2)+220, (height/2)-58, 36, 40); 
      break;
    case 6: 
      opcaoSelecionada_de_SomOuMusica((width/2)+268, (height/2)-58, 36, 40); 
      break;    
  }
}
...
function opcoesVolumeMusica(){  //VERIFICA AÇÃO DO MOUSE OU TECLADO NO MENU DE MÚSICA
  ...
  if(tecla_Press){ //VERIFICA E FAZ O MOVIMENTO DO TECLADO
    ...
    switch (botaoSelecionado) {
      case 1: //BOTÃO DE MUTE
        verificarOpcaoMenuTecladoSomOuMusica((width/2)+28, (height/2)+18, 36, 40, false, true, true, true, true, true, 0, 1, 4, 6, 2, 2, 3, 3, 3); 
        break;
      case 2: //VOLUME 1
        verificarOpcaoMenuTecladoSomOuMusica((width/2)+76, (height/2)+18, 36, 40, false, true, true, true, true, true, 0.05, 2, 4, 6, 1, 3, 3, 3, tela); 
        break;
      case 3: //VOLUME 2
        verificarOpcaoMenuTecladoSomOuMusica((width/2)+124, (height/2)+18, 36, 40, false, true, true, true, true, true, 0.1, 3, 4, 6, 2, 4, 3, 3, tela); 
        break;
      case 4: //VOLUME 3
        verificarOpcaoMenuTecladoSomOuMusica((width/2)+172, (height/2)+18, 36, 40, false, true, true, true, true, true, 0.15, 4, 4, 6, 3, 5, 3, 3, tela); 
        break;
      case 5: //VOLUME 4
        verificarOpcaoMenuTecladoSomOuMusica((width/2)+220, (height/2)+18, 36, 40, false, true, true, true, true, true, 0.2, 5, 4, 6, 4, 6, 3, 3, tela); 
        break;
      case 6: //VOLUME 5
        verificarOpcaoMenuTecladoSomOuMusica((width/2)+268, (height/2)+18, 36, 40, false, true, true, true, true, false, 0.25, 6, 4, 6, 5, null, 3, 3, tela); 
        break;
    }
  }
  ...
  switch (verificarVolumeMusica) {  //VERIFICA QUAL OPÇÃO DE VOLUME FOI ESCOLHIDA E DEIXA A OPÇÃO ESCOLHIDA MAIS ESCURA
    case 1: 
      opcaoSelecionada_de_SomOuMusica((width/2)+28, (height/2)+18, 36, 40); 
      break;
    case 2: 
      opcaoSelecionada_de_SomOuMusica((width/2)+76, (height/2)+18, 36, 40); 
      break;
    case 3: 
      opcaoSelecionada_de_SomOuMusica((width/2)+124, (height/2)+18, 36, 40); 
      break;
    case 4: 
      opcaoSelecionada_de_SomOuMusica((width/2)+172, (height/2)+18, 36, 40); 
      break;
    case 5: 
      opcaoSelecionada_de_SomOuMusica((width/2)+220, (height/2)+18, 36, 40); 
      break;    
    case 6: 
      opcaoSelecionada_de_SomOuMusica((width/2)+268, (height/2)+18, 36, 40); 
      break;
  }
}
...
function desenhaCobra(){  //DESENHA A COBRA NA TELA
  ...
  switch (direcaoCobra) { //DIREÇÃO QUE A COBRA DEVE ESTÁ OLHANDO
    case 'RIGHT': 
      image(imgOlhoCobraRight, cobra[0].x, cobra[0].y); 
      break;
    case 'LEFT': 
      image(imgOlhoCobraLeft, cobra[0].x, cobra[0].y); 
      break;
    case 'UP': 
      image(imgOlhoCobraUp, cobra[0].x, cobra[0].y); 
      break;
    case 'DOWN': 
      image(imgOlhoCobraDown, cobra[0].x, cobra[0].y); 
      break;
  }
}
...
function movimentoCobra(){  //REALIZA O MOVIMENTO DA COBRA E OUTRAS VERIFICAÇÕES DA COBRA
  ...
  if(direcaoCobra === 'RIGHT') 
    cobraX += sizeQuadradoCobra; 
  if(direcaoCobra === 'LEFT') 
    cobraX -= sizeQuadradoCobra;
  if(direcaoCobra === 'UP') 
    cobraY -= sizeQuadradoCobra;
  ...
  if(cobraX !== parseInt((width/2)-(32*(contMinX-1))+(32*(comida.x))) || cobraY !== parseInt((height/2)-(32*(contMinY-5))+(32*comida.y))){
    ...
    if(dificuldadePontuacao===1) 
      pontuacao += 10 + (num1+num2); 
    if(dificuldadePontuacao===2) 
      pontuacao += 25 + (num1-num2);
    if(dificuldadePontuacao===3) 
      pontuacao += 15 + (num1*num2);
    if(dificuldadePontuacao===4) 
      pontuacao += 50 + (num1/num2);
  ...
  if(cobra[0].x > (width/2)+(32*(contMaxX-2)) && direcaoCobra === 'RIGHT') 
    cobra[0].x = parseInt((width/2)-(32*(contMinX-1))); 
  if(cobra[0].x < (width/2)-(32*(contMinX-1)) && direcaoCobra === 'LEFT') 
    cobra[0].x = parseInt((width/2)+(32*(contMaxX-2))); 
  if(cobra[0].y > (height/2)+(32*(contMaxY-2)) && direcaoCobra === 'DOWN') 
    cobra[0].y = parseInt((height/2)-(32*(contMinY-4))); 
  if(cobra[0].y <= (height/2)-(32*(contMinY-3)) && direcaoCobra === 'UP') 
    cobra[0].y = parseInt((height/2)+(32*(contMaxY-2))); 

  //DEFINI A DIREÇÃO DA COBRA AO APERTAR UMA TECLA
  if((keyIsDown(68) || keyIsDown(RIGHT_ARROW)) && (direcaoCobra !== 'LEFT')) 
    direcaoCobra = 'RIGHT';
  else if((keyIsDown(65) || keyIsDown(LEFT_ARROW)) && (direcaoCobra !== 'RIGHT')) 
    direcaoCobra = 'LEFT';
  else if((keyIsDown(87) || keyIsDown(UP_ARROW)) && (direcaoCobra !== 'DOWN')) 
    direcaoCobra = 'UP';
  else if((keyIsDown(83) || keyIsDown(DOWN_ARROW)) && (direcaoCobra !== 'UP')) 
    direcaoCobra = 'DOWN';
}
...
function resizeTelaJogo(){  //FUNÇÃO PARA CALCULAR O TAMANHO DA TELA
  ...
  for(let i = (width/2); i < width; i+=32) 
    contMaxX++;
  for(let i = (width/2); i > 0; i-=32) 
    contMinX++;
  
  /*LAÇOS DE REPETIÇÕES PARA CONTAR QUANTOS QUADRADOS DE 32 PIXELS 
  VAI DO CENTRO ATÉ O INICIO DA TELA E DO CENTRO ATÉ O FINAL NA POSIÇÃO Y*/
  for(let i = (height/2); i < height; i+=32) 
    contMaxY++; 
  for(let i = (height/2); i > 0; i-=32) 
    contMinY++;

  /*LAÇOS DE REPETIÇÕES USADO PARA DELIMITAR ONDE A COMIDA DEVE SER GERADA*/
  for(let i = (width/2)-(32*(contMinX-1)); i <= (width/2)+(32*(contMaxX-2)); i+=32) 
    contMaxComidaX++;
  for(let i = (height/2)-(32*(contMinY-5)); i <= (height/2)+(32*(contMaxY-2)); i+=32) 
    contMaxComidaY++;
